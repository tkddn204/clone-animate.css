...
import {
  CalloutAnimationAction,
  CalloutAnimationTypes,
} from '../calloutAnimation/actions'
...
const CalloutAnimationReducer: Reducer<
  CalloutAnimationState,
  CalloutAnimationAction
